...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		...
		// 원하는 DB와 연결 할 수 있는 Connection 객체를 생성하는 객체
		...
		try {
			...
			// -> sql이 SELECT 문 일 때 결과로 ResultSet 객체 반환
			...
			System.out.println("해당 Class를 찾을 수가 없습니다.");
			e.printStackTrace();
		...
		e.printStackTrace();
			...
			// -> 자원 반환을 하지 않으면 DB와 연결된 Connection이 그대로 남아 있어서
